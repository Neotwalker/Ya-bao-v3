...
<article <?php wc_product_class( 'shop-card' . ( $out ? ' shop-card--out' : '' ), $product ); ?> data-type="<?php echo esc_attr( $type_slug ); ?>">
	<a class="shop-card__link" href="<?php echo esc_url( $link ); ?>">
		...
		<div class="shop-card__body">
			<div class="shop-card__meta"><span><?php echo esc_html( yabao_product_terms_text( $product ) ); ?></span><strong class="shop-card__price"><?php echo wp_kses_post( $product->get_price_html() ); ?></strong></div>
