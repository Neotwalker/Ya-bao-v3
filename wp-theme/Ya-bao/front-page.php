...
/*
 * Stage 68.2.2d2.
 * Events and guides use real WordPress entities.
 */

/*
 * Events.
 */
$events_eyebrow = $home_text(
    'home_events_eyebrow'
);

$events_title = $home_text(
    'home_events_title'
);

$events_intro = $home_text(
    'home_events_intro'
);

$events_cta_label = $home_text(
    'home_events_cta_label'
);

$events_archive_url = get_post_type_archive_link(
    'event'
);

if ( ! is_string( $events_archive_url ) ) {
    $events_archive_url = '';
}
...
/*
 * Guides / regular posts.
 */
$guides_eyebrow = $home_text(
    'home_guides_eyebrow'
);

$guides_title = $home_text(
    'home_guides_title'
);

$guides_intro = $home_text(
    'home_guides_intro'
);
...
<section class="section section--dark events-home-v4" id="events">
    <div class="container">
        ...
        <?php if ( $has_events_heading ) : ?>
            <div class="section-heading reveal">

                <?php if ( '' !== $events_eyebrow || '' !== $events_title ) : ?>
                    <div>

                        <?php if ( '' !== $events_eyebrow ) : ?>
                            <p class="eyebrow"><?php echo esc_html( $events_eyebrow ); ?></p>
                        <?php endif; ?>
                ...
                <?php if ( '' !== $events_intro ) : ?>
                    <p><?php echo esc_html( $events_intro ); ?></p>
                <?php endif; ?>
        ...
        <div
            class="events-slider-shell reveal"
            data-events-slider-shell
        >
            <div
            ...
            >
                <div class="swiper-wrapper">
                    ...
                    <?php foreach ( $events_home as $event_index => $event ) : ?>
                        <div class="swiper-slide">
                            ...
                            >
                                <div class="event-card__top">
                                    ...
                                    <span
                                        aria-hidden="true"
                                        class="event-card__index"
                                    >
                                        <?php
                                        echo esc_html(
                                            str_pad(
                                                (string) ( $event_index + 1 ),
                                                2,
                                                '0',
                                                STR_PAD_LEFT
                                            )
            ...
            <div
                ...
                class="events-slider__controls"
                role="group"
            >
                <button
                    aria-label="Предыдущие мероприятия"
                    class="events-slider__button events-slider__button--prev"
                    data-events-prev
                    type="button"
                >
                    <svg aria-hidden="true" viewBox="0 0 24 24">
                ...
                <div
                    aria-hidden="true"
                    class="events-slider__pagination"
                    data-events-pagination
                ></div>

                <button
                    aria-label="Следующие мероприятия"
                    class="events-slider__button events-slider__button--next"
                    data-events-next
                    type="button"
                >
                    <svg aria-hidden="true" viewBox="0 0 24 24">
        ...
        <?php if ( '' !== $events_cta_label && '' !== $events_archive_url ) : ?>
            <div class="section-tail reveal">
                <a
                    class="button button--ghost"
                    href="<?php echo esc_url( $events_archive_url ); ?>"
                >
                    <?php echo esc_html( $events_cta_label ); ?>
                    <span aria-hidden="true">→</span>
                </a>
            </div>
        <?php endif; ?>
...
<section class="section guides-v4" id="guides">
    <div class="container">
        ...
        <?php if ( $has_guides_heading ) : ?>
            <div class="section-heading reveal">

                <?php if ( '' !== $guides_eyebrow || '' !== $guides_title ) : ?>
                    <div>

                        <?php if ( '' !== $guides_eyebrow ) : ?>
                            <p class="eyebrow"><?php echo esc_html( $guides_eyebrow ); ?></p>
                        <?php endif; ?>

                        <?php if ( '' !== $guides_title ) : ?>
                            <h2><?php echo esc_html( $guides_title ); ?></h2>
                        <?php endif; ?>
                ...
                <?php if ( '' !== $guides_intro ) : ?>
                    <p><?php echo esc_html( $guides_intro ); ?></p>
                <?php endif; ?>
        ...
        <div
            class="guide-grid-v4 swiper"
            data-guides-swiper
        >
            <div class="swiper-wrapper">

                <?php foreach ( $guides_home as $guide ) : ?>
                    <div class="swiper-slide">
                        <a
                            class="guide-card-v4 guide-card-v4--link"
                            href="<?php echo esc_url( $guide['url'] ); ?>"
                        >

                            <?php if ( '' !== $guide['category'] ) : ?>
                                <span><?php echo esc_html( $guide['category'] ); ?></span>
                            <?php endif; ?>
                            ...
                            <div class="guide-card-v4__meta">

                                <span class="guide-card-v4__date">
                                    <?php echo yabao_article_calendar_icon(); ?>

                                    <time datetime="<?php echo esc_attr( $guide['date_iso'] ); ?>">
                                        <?php echo esc_html( $guide['date_display'] ); ?>
                                    </time>
                                </span>

                                <span class="guide-card-v4__views">
        ...
        <div
            ...
            class="guide-slider-v4__controls reveal"
            role="group"
        >
            <button
                aria-label="Предыдущие статьи"
                class="guide-slider-v4__button guide-slider-v4__button--prev"
                type="button"
            >
                <svg aria-hidden="true" viewBox="0 0 24 24">
                    <path
            ...
            <div
                aria-hidden="true"
                class="guide-slider-v4__pagination"
            ></div>

            <button
                aria-label="Следующие статьи"
                class="guide-slider-v4__button guide-slider-v4__button--next"
                type="button"
            >
                <svg aria-hidden="true" viewBox="0 0 24 24">
                    <path
